...
# Trained Model Path (Windows)
TRAINED_MODEL_WEIGHTS = r"C:\Users\winmo\Desktop\xai\myyolo\checkpoints\trained_model_weights.pt"

# VOC Dataset Directory (Windows)
PASCAL_VOC_DIR_PATH = r"C:\Users\winmo\Desktop\xai\myyolo\data\VOC_Detection"

# Save Image Path (Windows) — 폴더가 없으면 자동 생성됩니다.
ASSETS_DIR = r"C:\Users\winmo\Desktop\xai\myyolo\assets"
